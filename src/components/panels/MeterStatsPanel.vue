<template>
  <BasePanel class="meter-stats" title="电表设备统计">
    <div class="meter-stats__body">
      <div class="stat-card stat-card--online">
        <IconMeterOnline :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--cool">357</span>
          <span class="stat-card__label">在线(台)</span>
        </div>
      </div>
      <div class="stat-card stat-card--offline">
        <IconMeterOffline :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--warm">35</span>
...
import IconMeterOnline from '@/components/icons/IconMeterOnline.vue'
import IconMeterOffline from '@/components/icons/IconMeterOffline.vue'
</script>
