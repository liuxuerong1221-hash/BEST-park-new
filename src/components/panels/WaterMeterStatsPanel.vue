<template>
  <BasePanel class="water-meter-stats" title="水表设备统计">
    <div class="water-meter-stats__body">
      <div class="stat-card stat-card--online">
        <IconWaterMeterOnline :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--cool">214</span>
          <span class="stat-card__label">在线(台)</span>
        </div>
      </div>
      <div class="stat-card stat-card--offline">
        <IconWaterMeterOffline :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--warm">18</span>
...
import IconWaterMeterOnline from '@/components/icons/IconWaterMeterOnline.vue'
import IconWaterMeterOffline from '@/components/icons/IconWaterMeterOffline.vue'
</script>
