<template>
  <BasePanel class="broadcast-stats" title="广播设备统计">
    <div class="broadcast-stats__body">
      <div class="stat-card stat-card--online">
        <IconBroadcastOnline :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--cool">79</span>
          <span class="stat-card__label">在线(台)</span>
        </div>
      </div>
      <div class="stat-card stat-card--offline">
        <IconBroadcastOffline :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--warm">9</span>
...
import IconBroadcastOnline from '@/components/icons/IconBroadcastOnline.vue'
import IconBroadcastOffline from '@/components/icons/IconBroadcastOffline.vue'
</script>
