<template>
  <BasePanel class="barrier-stats" title="道闸设备统计">
    <div class="barrier-stats__body">
      <div class="stat-card stat-card--online">
        <IconGateOnlineNew :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--cool">28</span>
      ...
      <div class="stat-card stat-card--offline">
        ...
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--warm">2</span>
