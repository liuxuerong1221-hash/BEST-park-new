<template>
  <BasePanel class="dscreen-stats" title="信息发布屏统计">
    <div class="dscreen-stats__body">
      <div class="stat-card stat-card--online">
        <IconDisplayScreenOnline :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--cool">42</span>
          <span class="stat-card__label">在线(台)</span>
        </div>
      </div>
      <div class="stat-card stat-card--offline">
        <IconDisplayScreenOffline :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--warm">6</span>
...
import IconDisplayScreenOnline from '@/components/icons/IconDisplayScreenOnline.vue'
import IconDisplayScreenOffline from '@/components/icons/IconDisplayScreenOffline.vue'
</script>
