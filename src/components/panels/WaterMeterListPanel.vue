<template>
  <BasePanel class="water-meter-list" title="水表列表">
    <!-- 搜索 + 筛选 -->
    <div class="water-meter-list__toolbar">
    ...
    <!-- 表格 -->
    <div class="water-meter-list__table">
      ...
      <div class="water-meter-list__body">
        <div
          v-for="m in filtered"
          :key="m.id"
    ...
    <!-- 分页器 -->
    <div class="water-meter-list__pagination">
      <button
...
const STATUS_TEXT: Record<WaterMeterStatus, string> = {
  'online': '在线',
  'offline': '离线',
}
function statusLabel(s: WaterMeterStatus) { return STATUS_TEXT[s] }
...
const filter = ref<'all' | WaterMeterStatus>('all')
const filterOptions = [
...
function selectFilter(v: 'all' | WaterMeterStatus) {
  filter.value = v
