<template>
  <BasePanel class="turnstile-stats" title="摆闸设备统计">
    <div class="turnstile-stats__body">
      <div class="stat-card stat-card--online">
        <IconGateOnlineNew :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--cool">45</span>
          <span class="stat-card__label">在线(台)</span>
        </div>
      </div>
      <div class="stat-card stat-card--offline">
        <IconGateOfflineNew :size="60" />
        <div class="stat-card__info">
          <span class="stat-card__num stat-card__num--warm">5</span>
