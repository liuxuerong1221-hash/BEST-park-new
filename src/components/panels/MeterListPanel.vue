<template>
  <BasePanel class="meter-list" title="电表列表">
    <!-- 搜索 + 筛选 -->
    <div class="meter-list__toolbar">
    ...
    <!-- 分页器 -->
    <div class="meter-list__pagination">
      <button
...
function statusLabel(s: MeterStatus) { return STATUS_TEXT[s] }
...
function selectFilter(v: 'all' | MeterStatus) {
  filter.value = v
